...
class SyncTradingFacade:
    ...
    def cancel_order(self, order_id: OrderId) -> Tuple[bool, Any]:
        ...
        try:
            return self._run_async(
                self.async_service.cancel_order_async(order_id)
            )
        except Exception as e:
    ...
    def get_orders(self, symbol: Optional[Symbol] = None) -> List[Any]:
        ...
        try:
            return self._run_async(
                self.async_service.get_orders_async(symbol)
            )
        except Exception as e:
    ...
    def get_wallet_balances(self) -> List[Any]:
        ...
        try:
            return self._run_async(
                self.async_service.get_wallet_balances_async()
            )
        except Exception as e:
    ...
    def get_ticker(self, symbol: Symbol) -> Optional[Dict[str, Any]]:
        ...
        try:
            return self._run_async(
                self.async_service.get_ticker_async(symbol)
            )
        except Exception as e:
    ...
    def update_order(self, order_id: OrderId, price: Optional[Price] = None,
        ...
        try:
            return self._run_async(
                self.async_service.update_order_async(order_id, price, amount, delta, use_cancel_recreate)
            )
        except Exception as e:
            logger.error(f"Error in sync update_order: {e}")
            return False, str(e)
    
    def batch_place_orders(self, orders: List[Tuple[Symbol, str, Amount, Optional[Price]]]) -> List[Tuple[bool, Any]]:
        """
        ...
        try:
            return self._run_async(
                self.async_service.batch_place_orders_async(orders)
            )
        except Exception as e:
    ...
    def batch_cancel_orders(self, order_ids: List[OrderId]) -> List[Tuple[bool, Any]]:
        ...
        try:
            return self._run_async(
                self.async_service.batch_cancel_orders_async(order_ids)
            )
        except Exception as e:
    ...
    def start_websocket(self) -> bool:
        ...
        try:
            return self._run_async(
                self.async_service.start_websocket_async()
            )
        except Exception as e:
    ...
    def stop_websocket(self) -> bool:
        ...
        try:
            return self._run_async(
                self.async_service.stop_websocket_async()
            )
        except Exception as e:
