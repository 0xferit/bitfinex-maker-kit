...
class ServiceContainer:
    ...
    def create_order_manager(self, symbol: str, levels: int, spread_pct: float, 
                           size: float, side_filter: Optional[str] = None):
        """
    ...
    def create_market_maker_ui(self, symbol: str, center_price: float, levels: int,
    ...
    def create_order_generator(self, levels: int, spread_pct: float, size: float,
