...
class CacheService:
    ...
    async def start_background_warming(self, namespace: str, 
                                     keys: list, interval: float = 300.0) -> None:
        """
...
def create_cache_service(backend_type: CacheBackend = CacheBackend.MEMORY,
                        max_size: int = 1000, default_ttl: float = 30.0) -> CacheService:
    """
