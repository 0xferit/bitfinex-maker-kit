...
class BatchRequestService:
    ...
    async def make_request(self, request_type: str, params: Dict[str, Any],
    ...
    async def flush_pending_requests(self, request_type: Optional[str] = None) -> None:
        """
...
def create_batch_request_service(config: Optional[BatchConfig] = None) -> BatchRequestService:
    """
