...
class OrderGenerator:
    ...
    def __init__(self, levels: int, spread_pct: float, size: float, 
    ...
    def validate_center_price_range(self, center_price: float, 
    ...
    def suggest_center_price(self, bid: float, ask: float, 
                           preference: str = "mid") -> float:
        """
    ...
    def update_configuration(self, levels: Optional[int] = None,
                           spread_pct: Optional[float] = None,
                           size: Optional[float] = None,
                           side_filter: Optional[str] = None) -> None:
        """
        ...
        logger.info(f"Updated configuration: levels={self.levels}, spread={self.spread_pct}%, size={self.size}, filter={self.side_filter}")
