...
class CommandRouter:
    ...
    def _route_cancel(self, args: argparse.Namespace) -> None:
        ...
        cancel_command(
            args.order_id, args.size, args.direction, args.symbol,
    ...
    def _route_update(self, args: argparse.Namespace) -> None:
        ...
        update_command(
            args.order_id, args.price, args.amount, args.delta,
            args.filter_size, args.filter_direction, args.filter_symbol, 
            args.dry_run, args.yes, args.use_cancel_recreate
        )
    ...
    def _route_market_make(self, args: argparse.Namespace) -> None:
        ...
        market_make_command(
            args.symbol, args.center, args.levels, args.spread, 
    ...
    def _route_fill_spread(self, args: argparse.Namespace) -> None:
        ...
        fill_spread_command(
            args.symbol, args.target_spread, args.size, args.center, 
