    ...
    def profile_context(self, operation_name: str, 
        ...
        try:
            ...
            if memory_tracking and self.enable_memory_tracking:
                ...
                if memory_start:
                    memory_peak = max(memory_start, memory_current)
    ...
    def generate_performance_report(self) -> Dict[str, Any]:
        ...
        with self._lock:
            ...
            if total_executions > 0:
                all_durations = [
                    r.duration for results in self._profile_results.values()
                    for r in results
                ]
...
def profile(func_name: Optional[str] = None, memory_tracking: bool = True):
    """
