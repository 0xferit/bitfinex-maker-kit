...
class AsyncWebSocketConnectionManager:
    ...
    async def connect(self) -> bool:
        ...
        async with self._connection_lock:
            ...
            try:
                ...
                await self._emit_event('connection_error', {
                    'error': error_msg,
                    'attempt': self.connection_attempts
                })
    ...
    async def reconnect(self) -> bool:
        ...
        for attempt in range(self.config.reconnect_attempts):
            ...
            logger.info(f"Reconnection attempt {attempt + 1}/{self.config.reconnect_attempts} in {delay:.1f}s")
...
def create_connection_manager(client: BitfinexClientWrapper, 
                            config: Optional[ConnectionConfig] = None) -> AsyncWebSocketConnectionManager:
    """
