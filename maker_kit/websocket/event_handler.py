...
class WebSocketEventHandler:
    ...
    def __init__(self, order_manager: Any, client: Any):
        ...
        self.on_order_fill_callback: Optional[Callable] = None
        self.on_order_cancelled_callback: Optional[Callable] = None
    ...
    def _handle_partial_fill(self, order: Order, original_order: Dict[str, Any]) -> None:
        ...
        logger.info(f"Order {order.id} partially filled: {filled_amount:.1f}/{original_order['amount']} at ${fill_price:.6f}")
