...
def cancel_orders_by_criteria(size: Optional[float] = None, direction: Optional[str] = None, 
                             ...
                             price_above: Optional[float] = None, dry_run: bool = False, yes: bool = False):
...
def cancel_command(order_id: Optional[int] = None, size: Optional[float] = None, 
    ...
    elif (size is not None or direction or symbol or 
          price_below is not None or price_above is not None):
        # Cancel by criteria
        return cancel_orders_by_criteria(size, direction, symbol, 
                                       price_below, price_above, dry_run, yes)
    else:
