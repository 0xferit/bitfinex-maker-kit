...
class WebSocketUpdateStrategy(OrderUpdateStrategy):
    ...
    def _try_rest_update(self, order_id: int, price: float, amount: float, client: Any) -> OrderUpdateResult:
    ...
    def _try_websocket_update(self, order_id: int, price: float, amount: float, client: Any) -> OrderUpdateResult:
    ...
    def _try_direct_websocket_message(self, order_id: int, price: float, 
                                    amount: float, wss: Any) -> OrderUpdateResult:
