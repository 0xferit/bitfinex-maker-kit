...
from .base import OrderUpdateStrategy, OrderUpdateRequest
...
class UpdateStrategyFactory:
    ...
    def get_recommended_strategy(self, request: OrderUpdateRequest, 
                               client_capabilities: Optional[dict] = None) -> OrderUpdateStrategy:
        """
    ...
    def get_fallback_strategy(self, failed_strategy: OrderUpdateStrategy) -> Optional[OrderUpdateStrategy]:
        """
