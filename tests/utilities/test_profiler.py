...
from bitfinex_maker_kit.utilities.profiler import CodeProfiler, MemoryProfiler, PerformanceOptimizer
...
class TestMemoryProfiler:
    ...
    async def test_async_memory_monitoring(self):
        ...
        async def memory_intensive_task():
            data = []
            for i in range(1000):
                data.append(list(range(100)))  # Create nested lists
                if i % 100 == 0:
    ...
    def test_memory_leak_detection(self):
        ...
        assert leak_analysis["potential_leak"]
...
class TestPerformanceOptimizer:
    ...
    def test_bottleneck_identification(self):
        ...
        profile_data = {
            "fast_function": {"call_count": 1000, "total_time": 0.1, "avg_time": 0.0001},
            "slow_function": {"call_count": 10, "total_time": 5.0, "avg_time": 0.5},
            "moderate_function": {"call_count": 100, "total_time": 1.0, "avg_time": 0.01},
        }
    ...
    def test_optimization_recommendations(self):
        ...
        profile_data = {
            "database_query": {"call_count": 1000, "total_time": 10.0, "avg_time": 0.01},
            "api_call": {"call_count": 50, "total_time": 15.0, "avg_time": 0.3},
            "computation": {"call_count": 10000, "total_time": 2.0, "avg_time": 0.0002},
        }
        ...
        assert (
            "caching" in api_rec["recommendation"].lower()
            or "batch" in api_rec["recommendation"].lower()
        )
    ...
    async def test_performance_comparison(self):
        ...
        comparison = await optimizer.compare_implementations(
            {"impl_a": implementation_a, "impl_b": implementation_b}, test_args=[10], iterations=5
        )
