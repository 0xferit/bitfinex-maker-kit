...
from bitfinex_maker_kit.utilities.formatters import (
    format_amount,
    format_currency,
...
from bitfinex_maker_kit.utilities.response_parser import OrderResponseParser
from bitfinex_maker_kit.utilities.trading_helpers import (
    calculate_mid_price,
    calculate_order_total,
    calculate_spread,
    generate_levels,
)
from bitfinex_maker_kit.utilities.validators import (
    ValidationError,
    validate_amount,
...
class TestValidators:
    ...
    def test_validate_order_params_invalid(self):
        ...
        # Invalid field value
        invalid_params2 = {"symbol": "INVALID", "amount": "1.0", "price": "50000.0", "side": "buy"}
...
class TestResponseParser:
    ...
    def test_extract_order_id_from_response(self):
        ...
        response = {"id": 12345678, "symbol": "tBTCUSD", "amount": "1.0", "price": "50000.0"}
...
class TestTradingHelpers:
    ...
    @pytest.mark.parametrize(
        "center,spread_pct,levels,expected_range",
        [
