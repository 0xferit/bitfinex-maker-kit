...
class OrderFixture:
    ...
    amount_orig: Optional[str] = None
    executed_amount: str = "0.0"
    avg_execution_price: Optional[str] = None
    ...
    def mark_executed(self, execution_price: Optional[str] = None) -> 'OrderFixture':
...
class PortfolioFixture:
    ...
    def get_balance(self, currency: str) -> Optional[BalanceFixture]:
...
class TradingFixtures:
    ...
    @classmethod
    def create_order(cls, order_id: int = None, symbol: str = 'tBTCUSD', 
                    side: str = 'buy', **kwargs) -> OrderFixture:
    ...
    @classmethod
    def create_balance(cls, currency: str = 'USD', balance: float = 10000.0, **kwargs) -> BalanceFixture:
    ...
    @classmethod
    def create_portfolio(cls, currencies: Optional[List[str]] = None) -> PortfolioFixture:
    ...
    @classmethod
    def create_market_making_orders(cls, symbol: str = 'tBTCUSD', 
                                  center_price: float = 50000.0,
                                  levels: int = 3, spread_pct: float = 0.1) -> List[OrderFixture]:
    ...
    @classmethod
    def create_trading_history(cls, symbol: str = 'tBTCUSD', 
                             days: int = 7) -> List[OrderFixture]:
    ...
    def create_edge_case_orders(cls) -> Dict[str, OrderFixture]:
        ...
        return {
            ...
            'very_low_price': cls.create_order(
                symbol='tBTCUSD',
                amount='0.1',
                price='0.01'
            ),
            'very_high_price': cls.create_order(
                symbol='tBTCUSD',
                amount='0.1',
                price='1000000.0'
            ),
