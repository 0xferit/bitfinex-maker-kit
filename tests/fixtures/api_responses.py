...
class APIResponseFixtures:
    ...
    @classmethod
    def create_orderbook_response(cls, symbol: str = 'tBTCUSD', levels: int = 10) -> SuccessResponseFixture:
    ...
    @classmethod
    def create_trades_response(cls, symbol: str = 'tBTCUSD', count: int = 20) -> SuccessResponseFixture:
    ...
    @classmethod
    def create_error_response(cls, error_type: str = 'INVALID_REQUEST', 
                            status_code: int = 400) -> ErrorResponseFixture:
    ...
    @classmethod
    def create_batch_response(cls, requests: List[Dict[str, Any]]) -> List[Union[SuccessResponseFixture, ErrorResponseFixture]]:
