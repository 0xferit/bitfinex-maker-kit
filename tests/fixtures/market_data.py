...
class TradeHistoryFixture:
    ...
    def get_volume_weighted_price(self, duration: float = 3600.0) -> Optional[float]:
...
class MarketDataFixtures:
    ...
    @classmethod
    def create_multi_symbol_snapshot(cls, symbols: Optional[List[str]] = None) -> Dict[str, Dict[str, Any]]:
    ...
    @classmethod
    def create_volatile_market(cls, symbol: str = 'tBTCUSD', volatility: float = 0.02) -> TickerDataFixture:
