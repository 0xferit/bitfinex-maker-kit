...
class MockBitfinexClient:
    ...
    def get_orderbook(self, symbol: str = "tBTCUSD", precision: str = "P0") -> Mock:
    ...
    def cancel_order(self, order_id: int, symbol: str | None = None) -> Mock:
        ...
        response = self.fixtures.create_order_response(order_id=order_id, status="CANCELED")
    ...
    def get_orders(self, symbol: str | None = None) -> list[Mock]:
...
class MockAsyncClient:
    ...
    async def get_orderbook(self, symbol: str = "tBTCUSD", precision: str = "P0") -> Mock:
    ...
    async def cancel_order(self, order_id: int, symbol: str | None = None) -> Mock:
    ...
    async def get_orders(self, symbol: str | None = None) -> list[Mock]:
...
def create_mock_client(scenario: str = "normal") -> MockBitfinexClient:
    ...
    """
    scenarios = {
        "normal": {"api_key": "test_key", "api_secret": "test_secret", "response_delay": 0.0},
        "slow": {"api_key": "test_key", "api_secret": "test_secret", "response_delay": 0.5},
        "unauthenticated": {"api_key": "", "api_secret": "", "response_delay": 0.0},
        "very_slow": {"api_key": "test_key", "api_secret": "test_secret", "response_delay": 2.0},
    }
