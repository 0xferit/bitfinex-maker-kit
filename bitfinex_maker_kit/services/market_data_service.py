...
from ..utilities.market_data_cache import (
...
class MarketDataService:
    ...
    def __init__(
        self, container: ServiceContainer, cache_config: MarketDataCacheConfig | None = None
    ):
        """
    ...
    async def get_ticker(self, symbol: Symbol, use_cache: bool = True) -> dict[str, Any] | None:
        """
    ...
    async def get_orderbook(
        self, symbol: Symbol, precision: str = "P0", use_cache: bool = True
    ) -> dict[str, Any] | None:
        """
    ...
    async def get_account_balance(self, use_cache: bool = True) -> list[dict[str, Any]] | None:
        """
    ...
    async def get_recent_trades(
        self, symbol: Symbol, limit: int = 50, use_cache: bool = True
    ...
    async def get_multiple_tickers(
        self, symbols: list[Symbol], use_cache: bool = True
    ...
    async def suggest_price_centers(self, symbol: Symbol) -> dict[str, float] | None:
        """
...
def create_market_data_service(
    container: ServiceContainer, cache_config: MarketDataCacheConfig | None = None
) -> MarketDataService:
    """
